...
return [
    ...
    // 应用映射（自动多应用模式有效）
    'app_map'          => [
        Env::get('easyadmin.admin', 'guji') => 'admin',
        Env::get('easyadmin.qian', 'gj') => 'qian', // - yang
    ],
    // 后台别名
    'admin_alias_name' => Env::get('easyadmin.admin', 'guji'),
    // 'admin_alias_name' => Env::get('easyadmin.qian', 'gj'),
    // 域名绑定（自动多应用模式有效）
    'domain_bind'      => [],
