define(["jquery", "easy-admin", "treetable", "iconPickerFa", "autocomplete"], function ($, ea) {
    ...
    var init = {
        ...
        index_url: 'guji.catehigh/index',
        add_url: 'guji.catehigh/add',
        delete_url: 'guji.catehigh/delete',
        edit_url: 'guji.catehigh/edit',
        modify_url: 'guji.catehigh/modify',
    };
    ...
    var Controller = {
            ...
            var renderTable = function () {
                ...
                treetable.render({
                    ...
                    cols: ea.table.formatCols([[
                        {type: 'checkbox'},
                        {field: 'id', width: 100, title: 'ID', align: 'left'},
                        {field: 'pid', width: 80, title: 'PID', align: 'left'},
        ...
        add: function () {
            ...
            autocomplete.render({
                elem: $('#href')[0],
                url: ea.url('guji.catehigh/getMenuTips'),
                template_val: '{{d.node}}',
