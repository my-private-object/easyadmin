define(["jquery", "tableSelect", "ckeditor"], function ($, tableSelect, undefined) {
    ...
    var admin = {
        ...
        table: {
            ...
            renderToolbar: function (data, elem, tableId, init) { // - yang
                data = data || [];
                var toolbarHtml = '';
            ...
            tool: function (data, option) {
                option.operat = option.operat || ['edit', 'delete', 'importExcel'];
            ...
            select: function () { // - yang
                ...
                $.each(selectList, function (i, v) {
                    var url = $(this).attr('data-select'),
                        ...
                        valueTwo = $("select[name='cate_wbid']").attr('data-value'), // - yang
                        bidCateId = $("select[name='cate_bid']").attr('data-value'), // - yang
                    ...
                    admin.request.get(
                        {
                            ...
                            list.forEach(val => {
                                ...
                                if ( fields.length == 2 ) {
                                    ...
                                    if ( val[fields[2]] == bidCateId && valueTwo !== undefined && key.toString() === valueTwo ) {
                                        html += '<option value="' + key + '" selected="">' + val[fields[1]] + '</option>';
                                    } else if( val[fields[2]] == bidCateId ) {
                                        html += '<option value="' + key + '">' + val[fields[1]] + '</option>';
                                    }    
                                }
                            });
